    ...
    return (
        <div className="column-section">
            <div className="column-header">
                {showSamples && (
                    <div 
                        className="reload-link-div" 
                        onClick={handleRefresh}
                        title="Refresh sample values"
                    >
                        <div className={`refresh-icon ${isLoadingSamples ? 'spinning' : ''}`}>
                            &#x27F3;
                        </div>
                    </div>
                )}
                <div 
                    className="viewer_column" 
