...
class SpecialHighlight {
    ...
    constructor(startLineNumber: number, startColumn: number, endLineNumber: number, endColumn: number, kind: string, ast: any, catalog?: string, schema?: string) {
    ...
    getDecoration(namedQueries: Map<string, NamedQuery>) {
        ...
        var inlineClassName : String = this.kind;
